...
import { Star, Search, ChevronRight, Users, Loader2 } from 'lucide-react';
import { motion } from 'framer-motion';
import { useSpecialities, Speciality } from '@/hooks/useSpecialities';
...
const Specialities = () => {
  ...
  const { data: specialities = [], isLoading, isError } = useSpecialities();
  ...
  const getSpecialtyImage = (speciality: Speciality) => {
    return speciality.image_url || "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?q=80&w=800&auto=format&fit=crop";
  };
    ...
    <Layout>
      ...
      {isLoading && (
        <div className="flex justify-center items-center py-20">
          ...
          <p className="ml-2 text-lg">Loading specialities...</p>
        </div>
      )}
      ...
      {isError && (
        <div className="text-center py-12">
          <h3 className="text-xl font-medium text-red-500 mb-2">Failed to load specialities</h3>
          <p className="text-muted-foreground mb-4">
            There was a problem fetching the specialities data. Please try again later.
          </p>
              ...
              <motion.div key={speciality.id} variants={item}>
                ...
                >
                  <div 
                    ...
                    style={{ backgroundImage: `url(${getSpecialtyImage(speciality)})` }}
                  />
                  <CardContent className="p-6">
                    ...
                    <div className="flex justify-between items-center mb-4">
                      <div className="flex items-center">
                        ...
                        <span className="text-hospital-primary font-medium">{speciality.doctor_count}</span>
